...
<html lang="en">
  ...
  <body>
    ...
    <section class="eligibility" id="eligibility">
      <div class="container">
        ...
        <div class="row gy-6 pt-12">
          <div class="col-md-4">
            <div class="text-center">
              <img src="./images/eligibility-1.svg" alt="" />
          ...
          <div class="col-md-4">
            <div class="text-center">
              <img src="./images/eligibility-2.svg" alt="" />
          ...
          <div class="col-md-4">
            <div class="text-center">
              <img src="./images/eligibility-3.svg" alt="" />
    ...
    <section class="faq" id="faq">
      <div class="container">
        <h3 class="text-center text-white mb-12">Your Questions Answered</h3>
        <div class="row gy-6">
          <div class="col-md-6">
          ...
          <div class="col-12 text-center">
            <a href="" class="btn bg-white text-primary">Ask a Question?</a>
          </div>
        </div>
      </div>
    </section>
